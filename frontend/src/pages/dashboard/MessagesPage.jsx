...
export default function MessagesPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      {/* Page header */}
      <div className="mb-6">
        <h1 className="text-3xl font-heading font-bold text-gray-900">Messages</h1>
        <p className="text-gray-500 mt-1">Chat with landlords and tenants about properties.</p>
      </div>
        ...
        <div className="flex h-full">
          ...
          <div className={`w-full sm:w-80 flex-shrink-0 border-r border-gray-100 flex flex-col ${mobileView === 'chat' ? 'hidden sm:flex' : 'flex'}`}>
            <div className="p-4 border-b border-gray-100">
              <h2 className="font-bold text-gray-900 text-sm uppercase tracking-wide">Conversations</h2>
            </div>
            <div className="flex-1 overflow-y-auto">
              {loadingConvos ? (
                ...
                <div className="p-8 text-center text-gray-400">
                  ...
                  <p className="text-xs mt-1">Message a landlord from a property page.</p>
                </div>
              ) : (
                conversations.map(c => (
                  <ConvoItem
              ...
              <>
                ...
                <div className="flex-1 overflow-y-auto px-5 py-4 bg-gray-50/30">
                  {loadingMsgs ? (
                    ...
                    <div className="text-center text-gray-400 py-12 text-sm">No messages yet. Say hello!</div>
                  ) : (
                    messages.map(msg => (
